...
class TestCryptoMethods:
    @pytest.mark.parametrize("input, expected_hash", [
    ...
    def test_sha3_224(self, input, expected_hash):
        assert sha3_224(self, input) == json.dumps({'hash': expected_hash})
    ...
    def test_sha3_256(self, input, expected_hash):
        assert sha3_256(self, input) == json.dumps({'hash': expected_hash})
    ...
    def test_sha3_512(self, input, expected_hash):
        assert sha3_512(self, input) == json.dumps({'hash': expected_hash})
